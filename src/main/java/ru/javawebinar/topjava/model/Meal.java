...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.ALL_SORTED_BETWEEN_DATES, query = "SELECT m FROM Meal m " +
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String ALL_SORTED_BETWEEN_DATES = "Meal.getAllSortedBetweenDates";
