...
public abstract class AbstractMealServiceTest extends AbstractServiceTest {
    ...
    void deleteNotFound() throws Exception {
        Assertions.assertThrows(NotFoundException.class, () -> service.delete(MEAL1_ID, 1));
    }
    ...
    void getNotFound() throws Exception {
        Assertions.assertThrows(NotFoundException.class, () -> service.get(MEAL1_ID, ADMIN_ID));
    }
    ...
    void updateNotFound() throws Exception {
        NotFoundException thrown = Assertions.assertThrows(NotFoundException.class, () -> service.update(MEAL1, ADMIN_ID));
