...
- **Обновления базы соискателей буду рассылать по HR ночью на 24.05, постарайтесь успеть**
- Сделать и внести в свое портфолио <a href="https://github.com/JavaWebinar/topjava/blob/doc/doc/graduation.md#graduation-project">Graduation project</a>
  - Для участников с проверкой выпускной проект принимаю на ревью до 07.06 (участникам <a href="http://javaops.ru/reg/masterjava">Masterjava</a> до 01.11).
...
- **Внимание: резюме на hh или других ресурсах ДОЛЖНО БЫТЬ ОТКРЫТО ДЛЯ ПРСМОТРА**
